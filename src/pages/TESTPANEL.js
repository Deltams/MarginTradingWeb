...
export default class TraderAccount extends Component {
    ...
    async sendSetLpToCA() {
        if (this.state.userAccount !== ""){
            ...
            try {
                await SCContract.setSwapContract('0xED18bF2187b214F988aAaF36Ac41d01E1cb6375F');
                // await SCContract.quoteExactInputSingle.staticCall(this.addressWETH, this.addressUSDC, ethers.parseUnits('500', 0), ethers.parseUnits('1', 18), ethers.parseUnits('0', 0));
                this.onToastUser('OK', false);
                // this.onToastUser(ethers.formatUnits(await SCContract.quoteExactInputSingle.staticCall(this.addressWETH, this.addressUSDC, ethers.parseUnits('500', 0), ethers.parseUnits('1', 18), ethers.parseUnits('0', 0)), 6), false);
            } catch (err) {
                this.onToastUser(err.message, true);
            }
        } else {
